...
I have the following file in my document in Typst:
...
And here's the unformatted content:
...
#figure(
  align(center)[#table(
      ...
      table.hline(),
      [1. El actor ingresa el código del salón de belleza], [
        2. Verifica
        que el salón de belleza exista en el sistema.],
      [3. Ingresa el enlace o URL de su red social.], [
        4. Se verifica que
...
#figure(
  align(center)[#table(
      ...
      [
        ...
        4. Se verifica que la sucursal no
...
The first one example would be "Gestionar Peluquería/Salón", and formatted to typst would be:
...
#fully-dressed-use-case(
  ...
  main-success-scenario: [
    ...
    + Se verifica que la peluquería no exista en el sistema, con el correo.
    + Se ingresa la red social.
...
Now, I want you to reformat every use case in the unformatted document to the formatted version, using the example as reference. You can omit the images.

The name is the use case name, the primary actor is the actor, the stakeholders-interests is the purpose, the success-guarantee is the postcondition, the main-success-scenario is the course basic, and the extension is the course alternative.
