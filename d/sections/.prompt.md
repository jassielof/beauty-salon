Tengo los siguientes casos de uso hechos con typst en el formato de larman (fully dressed use-case) cada caos de uso usa la función fully-dressed-use-case que toma sus debidos parámetros, pero el problema es que los casos de uso no implementan o detallan todos los casos de uso según la función de typst. necesito que detalles y completes todas las restantes, y mejores la redacción de los casos de uso. La redacción no debe ser técnica, sino simple y entendible para gente común (tanto sin ambigüedades):
